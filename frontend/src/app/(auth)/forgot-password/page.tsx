...
import { Sun, Moon, Languages, Mail, Check, ArrowRight, ArrowLeft } from 'lucide-react';
          ...
          {submitted ? (
            <div className="text-center py-6">
              ...
              <p className="text-xs text-slate-400 mt-2 leading-relaxed">
                {lang === 'ar' 
                  ...
                  : 'Instructions to restore your password have been sent to your email.'}
              </p>
            ...
            <div>
              <div className="text-center mb-6">
                <h1 className="text-xl font-bold tracking-tight">{t.forgotPassTitle}</h1>
                <p className="text-xs text-slate-400 mt-2">{t.forgotPassSubtitle}</p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-11 pr-4 py-3 bg-slate-950/40 border border-white/5 rounded-xl text-sm focus:border-indigo-500 focus:outline-none transition"
                    />
                  </div>
                </div>

                <button type="submit" className="w-full glow-btn font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 cursor-pointer">
